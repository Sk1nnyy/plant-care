...
fun Context.buildWaterReminderNotification(
    ...
    return NotificationCompat
        ...
        .setContentTitle(getString(R.string.title_notification_water, plantName))
        .setContentText(getString(R.string.message_notification_water))
        .setAutoCancel(true)
        .addAction(
            R.drawable.ic_arrow_right,
            getString(R.string.action_mark_as_watered),
...
fun Context.scheduleDailyPlantReminder(
    ...
    val days =
        when (schedule) {
            WateringSchedule.Daily -> 1
            is WateringSchedule.Monthly -> 30
            is WateringSchedule.MultipleDaysInWeek -> 1
            WateringSchedule.None -> 0
            is WateringSchedule.Weekly -> 7
        }.toLong()
    val workRequest =
