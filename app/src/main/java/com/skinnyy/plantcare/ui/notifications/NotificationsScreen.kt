...
internal fun NotificationsScreen(
    ...
    NotificationsContent(uiState = uiState, onEvent = { viewModel.onEvent(it) })
}
    ...
    Scaffold(
        ...
        Column(
            ...
            AnimatedVisibility(uiState.notificationsEnabled.enabled) {
                Card {
                    Column {
                        SettingsItem("Watering", isChecked = uiState.notificationsEnabled.watering, {
                            onEvent(NotificationsViewModel.UiEvent.SetWateringNotificationEnabled(it))
                        })
                        HorizontalDivider(Modifier.padding(horizontal = 16.dp))
                        SettingsItem("Commercial", isChecked = uiState.notificationsEnabled.communication, {
                            onEvent(NotificationsViewModel.UiEvent.SetCommunicationNotificationEnabled(it))
                        })
                    }
                }
            }
