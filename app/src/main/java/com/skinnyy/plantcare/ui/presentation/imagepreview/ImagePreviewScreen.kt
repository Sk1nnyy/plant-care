package com.skinnyy.plantcare.ui.presentation.imagepreview
...
fun ImagePreviewContent(
    ...
    Scaffold(
        ...
        ZoomableAsyncImage(model = url, contentDescription = null, modifier = Modifier.fillMaxSize().padding(it))
    }
}
