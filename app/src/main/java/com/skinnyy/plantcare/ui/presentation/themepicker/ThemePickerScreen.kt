package com.skinnyy.plantcare.ui.presentation.themepicker
...
internal fun ThemePickerScreen(
    ...
    ThemePickerContent(uiState.userTheme, onEvent = { viewModel.onEvent(it) }, modifier)
}
...
private fun ThemePickerContent(
    ...
    var selectedTheme by remember(userTheme) { mutableStateOf(userTheme) }
